...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('/store/mc/Phase2Spring24DIGIRECOMiniAOD/TT_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_AllTP_140X_mcRun4_realistic_v4-v1/130000/571878dc-2ad9-4f0e-ad48-a5df105f0108.root'),
...
#CMP 
process.pDTPattern = cms.Path(process.patternDtTriggerPhase2PrimitiveDigis)

#CMP
process.gmtStubsDTPattern = process.gmtStubs.clone(
        srcDT = cms.InputTag("patternDtTriggerPhase2PrimitiveDigis")
)
process.pStubsDTPattern = cms.Path(process.gmtStubsDTPattern)

#CMP
process.gmtKMTFMuonsDTPattern = process.gmtKMTFMuons.clone(
        stubs      = cms.InputTag('gmtStubsDTPattern','kmtf')
)
process.pKMTFMuonsDTPattern = cms.Path(process.gmtKMTFMuonsDTPattern)
...
process.schedule = cms.Schedule(process.raw2digi_step,
                              ...
                              process.pDTPattern, #CMP
                              process.pStubsDTPattern, #CMP
                              process.pKMTFMuonsDTPattern, #CMP
                              process.endjob_step)
